export const services = [
  {
    ...
    description:
      "Nous animons et engageons votre communauté sur les réseaux sociaux avec du contenu attractif, une modération efficace et une interaction authentique pour renforcer votre image de marque.",
  },
  {
    type:"DW",
    title: "Développement Web & Mobile :",
    description:
      "Nous concevons des sites web et applications mobiles modernes, responsives et optimisés pour garantir une expérience utilisateur fluide tout en améliorant votre référencement naturel pour une meilleure visibilité en ligne.",
  },
  {
    type:'ADS',
    title: "Ads (Meta et GOOGLE )",
    description:
      "Nous concevons des campagnes publicitaires ciblées sur Google, Facebook et Instagram afin de maximiser votre visibilité, attirer un trafic qualifié et augmenter vos conversions, tout en optimisant votre budget publicitaire.",
  },
  {
    type:'IA',
    title: " Intelligence Artificielle",
    description:
      "Nous intégrons l’IA dans vos stratégies digitales pour automatiser les tâches, personnaliser l’expérience client et améliorer l’efficacité de vos campagnes marketing.",
  },
];
